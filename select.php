<html>
	...
	<!-- Optional theme -->
	<link rel="stylesheet" href="hasset/bootstrap/css/bootstrap-theme.min.css">
...
$db->select('products',$row = '*', $join = null, $where = null, $order = null, $limit = null); // Table name, Column Names, JOIN, WHERE conditions, ORDER BY conditions
$res = $db->getResult();
//echo "<pre>";
//print_r($res);
...
<span class="ulyphicon glyphicon-plus"></span> Insert</a>
